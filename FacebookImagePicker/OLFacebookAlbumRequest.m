        ...
        [[[FBSDKGraphRequest alloc] initWithGraphPath:graphPath
             ...
             if (!error) {
                 ...
                 for (id album in data) {
                     ...
                     album.name = name;
                     album.coverPhotoURL = [NSURL URLWithString:[NSString stringWithFormat:@"https://graph.facebook.com/%@/picture?type=small&access_token=%@", album.albumId, [FBSDKAccessToken currentAccessToken]]];
